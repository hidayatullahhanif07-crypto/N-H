...
export default function OpeningCover({ onOpen, guestName }: OpeningCoverProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex flex-col items-center justify-center overflow-hidden bg-cream-soft px-4 py-8 animate-slow-zoom-bg"
      id="opening-cover"
    >
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="show"
        className="relative max-w-lg w-full bg-white/45 backdrop-blur-xl p-10 md:p-14 rounded-t-[200px] rounded-b-[60px] text-center flex flex-col items-center justify-center shadow-[0_30px_70px_rgba(26,54,93,0.15)] z-20 border border-slate-200/50 overflow-hidden light-sweep-container"
        id="cover-card"
      >
        ...
        <motion.div variants={itemVariants} className="space-y-3 mb-8 z-10 w-full px-2">
          <h1 className="font-vibes text-5xl md:text-6.5xl text-navy tracking-wide animate-name-glow drop-shadow-[0_2px_15px_rgba(126,200,227,0.15)]">
